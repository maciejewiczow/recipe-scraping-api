...
from shared.models.chat.chat_models import create_chat_models
...
def handler(
    ...
    _, Ingredients = create_chat_models("en")
    ...
    try:
        ...
        try:
            ingredients = Ingredients.model_validate_json(response.output_text)
